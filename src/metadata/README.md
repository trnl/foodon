 ...
 * [foodon.yml](foodon.yml)
     * Determines how your purl.obolibrary.org/obo/foodon/ redirects will be handled
     ...
     * Paste in the contents of [foodon.yml](foodon.yml)
 ...
 * [foodon.md](foodon.md)
     ...
     * Paste in the contents of [foodon.md](foodon.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
